...
namespace DemandApp
{
    public partial class Registration1 : System.Web.UI.Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (RoleID == "2" )
            {
                string query = "insert into MST_LOGINDETAILS(COMPANYID,USERID,PASSWORD,ROLEID,ROLENAME,NAME,ADDRESS,GSTNO,LOGINTYPE,CREATEDDATE,CREATEDBY,MODIFIEDDATE,MODIFIEDBY,IPADD) VALUES ('" + DDlcompany.SelectedValue + "', '" + userid + "', '" + userid + "@123', '" + RoleID + "', '" + RoleName + "','" + name + "','" + add + "','" + GSTno + "','" + loginType + "',getdate(), 'Admin',null,null,'" + ipadd + "')";
                try
                {
            ...
            else if (RoleID == "1"  && IsValidEmail(mail) && IsValidPhone(phn))
            {
                string query = "insert into MST_LOGINDETAILS(COMPANYID,USERID,PASSWORD,ROLEID,ROLENAME,NAME,ADDRESS,GSTNO,LOGINTYPE,CREATEDDATE,CREATEDBY,MODIFIEDDATE,MODIFIEDBY,IPADD) VALUES ('" + DDlcompany.SelectedValue + "', '" + userid + "', '" + userid + "@123', '" + RoleID + "', '" + RoleName + "','" + name + "','" + add + "','" + GSTno + "','" + loginType + "',getdate(), 'Admin',null,null,'" + ipadd + "')";
                try
                {
